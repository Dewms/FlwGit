 ...
 */
public class AdvancedFacialsServicesActivityList extends BaseActivity {

    public AdvancedFacialsServicesActivityList(int image_id,int image_id_details,String header, String titles, String prices, String contents)
    {
