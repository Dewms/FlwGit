...
/**
 * Created by Jumer Nicerio on 3/17/2016.
 */
public class BodyServicesDetailsActivity extends BaseActivity {
    ImageView img_serv;
    TextView tx_title;
    TextView tx_price;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_bodyservices_details);

        img_serv= (ImageView) findViewById(R.id.img_services_details);
        tx_title= (TextView) findViewById(R.id.txt_body_details_title);
        tx_price= (TextView) findViewById(R.id.txt_body_details_price);
        tx_contents= (TextView) findViewById(R.id.txt_body_details_content);
