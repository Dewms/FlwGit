 ...
 */
public class HairActivityList extends BaseActivity {

    public HairActivityList(int image_id,int image_id_details,String header, String titles, String prices, String contents)
    {
