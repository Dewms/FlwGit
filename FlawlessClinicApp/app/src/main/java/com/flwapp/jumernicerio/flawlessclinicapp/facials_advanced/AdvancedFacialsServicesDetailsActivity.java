...
/**
 * Created by Jumer Nicerio on 3/18/2016.
 */
public class AdvancedFacialsServicesDetailsActivity extends BaseActivity {
    ImageView img_serv;
    TextView tx_title;
    TextView tx_price;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_advancedfacials_details);

        img_serv= (ImageView) findViewById(R.id.img_afacials_details);
        tx_title= (TextView) findViewById(R.id.txt_afacials_details_title);
        tx_price= (TextView) findViewById(R.id.txt_afacials_details_price);
        tx_contents= (TextView) findViewById(R.id.txt_afacials_details_content);
