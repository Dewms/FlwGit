 ...
 */
public class HairActivityDetails extends BaseActivity {
    ImageView img_serv;
    TextView tx_title;
    TextView tx_price;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_hair_details);

        img_serv= (ImageView) findViewById(R.id.img_hair_details);
        tx_title= (TextView) findViewById(R.id.txt_hair_details_title);
        tx_price= (TextView) findViewById(R.id.txt_hair_details_price);
        tx_contents= (TextView) findViewById(R.id.txt_hair_details_content);
