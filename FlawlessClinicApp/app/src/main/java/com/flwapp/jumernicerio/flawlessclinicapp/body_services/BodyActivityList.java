 ...
 */
public class BodyActivityList extends BaseActivity {

    public BodyActivityList(int image_id,int image_id_details,String header, String titles, String prices, String contents)
    {
